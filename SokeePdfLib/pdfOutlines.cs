...
namespace SokeePdfLib
{
    internal class pdfOutlines : IWritable
    {
        ...
        private List<pdfBookmarkNode> _BookmarkRoot = new List<pdfBookmarkNode>();
        ...
        private int initializeBookmarks(int CounterID, List<pdfBookmarkNode> StartPoint, int FatherID)
        {
            int currentNodes = 0;
        ...
        private List<pdfBookmarkNode> getNodes(List<pdfBookmarkNode> StartPoint)
        {
        ...
        {
            List< pdfBookmarkNode> returnedList = getNodes(_BookmarkRoot);
            returnedList.Sort();
            return returnedList;
        }
